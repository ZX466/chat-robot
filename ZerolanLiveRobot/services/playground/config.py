...
class PlaygroundBridgeConfig(BaseModel):
    ...
    host: str = Field(default="127.0.0.1",
                      description="The host address of the PlaygroundBridge server. Use 0.0.0.0 to expose to network.")
    ...
    bot_id: str = Field(default="default_bot",
    ...
    res_server_port: int = Field(default=8899,
                                 description="The port number of the Resource HTTP server.")
